use rt::{
    Camera, Color, Cube, Cylinder, Dielectric, Direction, Emissive, Lambertian, Metal, Object,
    Plane, Position, Result, Scene, Sphere, IMAGE_HEIGTH as height, IMAGE_WIDTH as width,
};
